...
const CollegeFacilities = ({campusFacility} : {campusFacility:any}) => {
  ...
  const fallbackImage = 'https://images.unsplash.com/photo-1562774053-701939374585?q=80&w=1486&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';
