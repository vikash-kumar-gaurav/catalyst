...
let pageData = {
  metadata: {
    title: "Code of Conduct | CATALYST College",
    description: "Official code of conduct for students, faculty and staff at CATALYST College - outlining academic, behavioral and professional expectations",
    keywords: "college rules, student conduct, academic integrity, campus discipline, anti-ragging policy",
    og: {
      title: "Code of Conduct | CATALYST College",
      description: "Standards of behavior and ethical expectations for our academic community",
      type: "website",
      url: "https://www.catalystcollege.edu.in/code-of-conduct",
      image: "https://catalystcollege.edu.in/wp-content/uploads/2023/07/campus-conduct.jpg"
    }
  },
  heroSection: {
    title: "Code of Conduct",
    description: "Our shared commitment to integrity, respect and academic excellence",
    imageUrl: "https://catalystcollege.edu.in/wp-content/uploads/2023/07/campus-conduct.jpg",
    overlayOpacity: 0.3,
    height: "lg"
  },
  content: {
